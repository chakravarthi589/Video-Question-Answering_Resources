...
#### 2024
-[A Survey on Generative AI and LLM for Video Generative Understanding,and Streaming](https://arxiv.org/abs/2404.16038)
#### 2021
-[Video Question Answering: a Survey of Models and Datasets (Springer)](https://link.springer.com/article/10.1007/s11036-020-01730-0#ref-CR57)
#### 2020
-[A survey on VQA:Datasets and approaches(ITCA)](https://doi.org/10.1109/ITCA52113.2020.00069)
...
- **IEEE Transactions**
  -[Event Graph Guided Compositional Spatial-Temporal Reasoning for Video Question Answering(IEEE Transaction)](https://doi.org/10.1109/TIP.2024.3358726)
-**Preprints**
...
-**CVPR**
  ...
  -[From representation to reasoning:Towards both evidence and commmonsense reasoning for video question answering](https://openaccess.thecvf.com/content/CVPR2022/papers/Li_From_Representation_to_Reasoning_Towards_Both_Evidence_and_Commonsense_Reasoning_CVPR_2022_paper.pdf)
-**NeurIPS**
...
-**AAAI**
  -[Self-supervised Pre-training and Constrastive Representation Learning for Multiple-choice Video QA](https://doi.org/10.1609/aaai.v35i14.17556)
-**ACM**
...
-**ACL**
  -[TVQA+:Spatio-Temporal Grounding for Video Question Answering (ACL)](https://aclanthology.org/2020.acl-main.730/)
...
-**AAAI**
  - [Beyond RNNs:Positional Self-Attention with Co-Attention for Video Question](https://doi.org/10.1609/aaai.v33i01.33018658)
-**IEEE**
...
-**ACM**
  -[Explore Multi-Step Reasoning in Video Question Answering(ACM)](https://dl.acm.org/doi/10.1145/3240508.3240563)
